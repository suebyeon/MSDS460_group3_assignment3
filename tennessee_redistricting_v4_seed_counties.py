# -*- coding: utf-8 -*-
"""Tennessee_Redistricting_v4_seed_counties.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1-c_SZBMePytrhtByqa2AXlUW7OGXQW_N
...
# change pop limits to 0.7 and 1.3 to see if that helped spped up solving

pop_min = 0.5 * target_population
pop_max = 1.5 * target_population
